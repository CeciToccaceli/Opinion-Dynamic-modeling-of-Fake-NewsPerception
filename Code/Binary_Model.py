...
class WSHkModel(DiffusionModel):
    """
    ...
    Vector consists of 6 binary elements and it represents the character of a node.
    """
    def __init__(self, graph):
        ...
        self.name = "Weighted Stubbornness HK"
    def set_initial_status(self, configuration=None):
        ...
        """
        super(WSHkModel, self).set_initial_status(configuration)
